	...
	class RestServer
	{
	    ...
	    public function handle() {
	        ...
	        if ($this->methodIsDefinedInRequest()) {
	            ...
	            $callback=$requestAttributes["callback"]?:"";
	            ...
	            if ($serviceClass != null) {
	                ...
	                if (!$ref->isPublic()) {
	                    if($callback==""){
	                        ...
	                        echo $callback.'('.json_encode(array('error' => 'API call is invalid.')) .')';
	                    }
	                    return ;
	                }
	                ...
	                if (count($pArray) == $paramCount && !in_array(null, $pArray)) {
	                    ...
	                    if($callback==""){
	                        ...
	                        echo $callback.'('.json_encode(array('error' => "Required parameter(s) for ". $method .": ". $paramStr)) .')';
	                    }
	                }
	            }
	            else { 
	                ...
	                {
	                    echo $callback.'('.json_encode(array('error' => "The method " . $method . " does not exist.")).')';
	                }
	            }
	        }
	        else {
	            if(($requestAttributes["callback"]?:"")==""){
	                echo json_encode(array('error' => 'No method was requested.'));
	            }
	            else{
	                echo $requestAttributes["callback"].'('.json_encode(array('error' => 'No method was requested.')).')'; 
	            }
	        }
	    }
